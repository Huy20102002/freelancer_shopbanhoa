		...
		<div class="panel panel-info">
			<div class="panel-body">
				...
				<div class="table-responsive">
					...
					<?php if ($transaction->status == '0') { ?>
						<a href="<?php echo admin_url('transaction/accept/' . $transaction->id . '?status=1'); ?>" class="btn btn-success"> Xác nhận đơn hàng</a> <?php
																																								} ?>
					<?php if ($transaction->status != '2') { ?>
						<a href="<?php echo admin_url('transaction/accept/' . $transaction->id . '?status=2'); ?>" class="btn btn-danger">Hủy đơn</a>
